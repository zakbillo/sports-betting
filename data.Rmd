...
We realized website that was scraped to obtain this data had dynamic filters that switched the year of the displayed data. To overcome the lack of static data, we manually scraped the tables for previous years and saved the data in a CSV format
