...
``` r
urban_raw <- read_csv("DECENNIALDHC2020.P2_2025-12-03T233707/DECENNIALDHC2020.P2-Data.csv")
```
...
# -----------------------------
# Start from legal-gambling states with actual Revenue
# model_clean_2024 should already have:
#   State, Revenue, total_pop, median_income, pct_bachelors, 
#   pct_age_20_34, pct_urban, pct_poverty, etc.
...
``` r
# -----------------------------
# 3) Predict revenue if these states legalized gambling
# -----------------------------
pred_illegal <-
  newdata_illegal |>
  mutate(
